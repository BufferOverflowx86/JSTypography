 ...
 * @example   jstypograf({obj:["my_button","button2"],tabobj:"sub_button",bind:"click",language:"rus",type:"norm",txts:["textarea1","bl17~textarea2","+abc"],off:["quotes"]})
 */
...
(function(undefined){
	window.typo=window.jstypograf=window.jstypograph=jstypo=function(TYPO){
		...
		/** Затычка для цвета поста, просто частный случай **/
		function rS2T(a){
			a=a.r(/(\[color=[^\r\n]*\])( | )( | )( | )( | )/g,"$2"+"$3"+"$4"+"$5"+"$1").r(/(\r\n|\r|\n|^)( | )( | )( | )( | )/g,"$1&nbsp; &nbsp; ").r(/(\r\n|\r|\n|^)(\[[\w"=#]+\])( | )( | )( | )( | )/g,"$1"+"$2&nbsp; &nbsp; ");
			return a;
		};
