...
----------------------------------------------------------------------------------
    Пример установки на форум Ucoz (включены все опции кроме <br>, символьный режим, замена неразрывного пробела на строку &nbsp; перед отправкой):
...
----------------------------------------------------------------------------------
    Где http://your_site/jstypography_minified.js — ссылка на загруженный скрипт.
    5) Найдите текст:
----------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------
    Пример установки на forum2x2 phpBB2 (включены все опции кроме <br>, символьный режим):
...
----------------------------------------------------------------------------------
    ...
    Большая просьба, по всем вопросам, пожеланиям, найденным ошибкам пишите на ICQ 436149026, либо на ящик buffer.overflow.x86@gmail.com

    © Даниил Ерошенко "-1.#IND0000" <buffer.overflow.x86@gmail.com>, UnderShot <mail@undershot.ru>, 2012–2013 год